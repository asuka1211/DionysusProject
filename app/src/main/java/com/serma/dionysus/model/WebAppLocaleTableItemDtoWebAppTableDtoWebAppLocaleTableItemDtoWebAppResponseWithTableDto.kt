...
data class WebAppLocaleTableItemDtoWebAppTableDtoWebAppLocaleTableItemDtoWebAppResponseWithTableDto (
    ...
    @SerialName("result")
    val result: WebAppLocaleTableItemDtoWebAppTableDto? = null
) : Serializable {
    companion object {
